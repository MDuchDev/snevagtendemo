export const navItems = [
    { name: "Forside", link: "#forside" },
    { name: "Services", link: "#services" },
    { name: "Cases", link: "#cases" },
    { name: "Kompetencer", link: "#kompetencer" },
  ...
  export const gridItems = [
    {
      ...
      description: "",
      className: "lg:col-span-3 md:col-span-6 md:row-span-4 lg:min-h-[60vh] sm:flex hidden",
    ...
    {
      id: 6,
      title: "Skal vi starte et projekt sammen?",
      description: "",
      className: "lg:col-span-2 md:col-span-3 md:row-span-1",
      imgClassName: "",
